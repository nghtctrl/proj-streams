...
The descriptive tables were manually constructed using the outputs from [Appendix C](#sec-appendix-c). To produce these tables, we first cleaned and prepared the survey data. For more details on the data cleaning and preparation process, please refer to [Appendix B](#sec-appendix-b).
